...
@Component({
  selector: 'app-navi-member-link',
  templateUrl: './navi-member-link.component.html',
  styleUrls: ['./navi-member-link.component.scss']
})
export class NaviMemberLinkComponent implements OnInit {
  options: option[] = [];
  selectedId: number = 0;
  name: string = '';

  constructor(
    public dialogRef: MatDialogRef<NaviMemberLinkComponent>,
